            ...
            <div className="p-4 sm:ml-64">
                <div className="  border-dashed rounded-lg ">
                    ...
                    <div className=' flex flex-row gap-10'>
                        <p className=' underline  underline-offset-8'>New Assigned</p>
                        <p>Completed</p>
                    </div>
...
const Tasks = ({ ProjcetIcon, ProjectName, ProjectDesc, PorjectStc, ProjectPer }) => {
    return (
        <div className=' mt-3  flex flex-row justify-center items-center rounded-lg  shadow-xl  w-max h-16 bg-white border'>
            ...
            <div className=' ml-10 p-2 relative  w-80'>
                <div className="flex justify-between mb-2">
                    <span className="text-base font-medium text-pink-700 dark:text-white">{PorjectStc}</span>
                    <span className="text-sm font-medium text-pink-700 dark:text-white">{ProjectPer}</span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-1.5 dark:bg-gray-700">
                    <div className="bg-pink-600 h-1.5 rounded-full " style={{ width: ProjectPer }}></div>
                </div>
            </div>
